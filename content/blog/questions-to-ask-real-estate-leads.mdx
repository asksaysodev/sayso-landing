...
If a lead raises an objection mid-sequence ("I already have an agent," "I'm just looking"), do not abandon your question to handle the objection immediately. Acknowledge it first, then get back to where you were. The [not interested objection handler](/objections/not-interested/) and the [call me later handler](/objections/call-me-later/) cover how to manage this without losing the thread.
</CalloutBox>
