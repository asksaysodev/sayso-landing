...
seoTitle: "Questions to Ask Real Estate Leads"
description: "Use these buyer and seller lead questions to uncover timeline, motivation, financing, and next steps without making the conversation feel scripted."
...
The best questions to ask real estate leads uncover six things: location, price, motivation, agent status, mortgage readiness, and the next appointment. The questions should feel like a conversation, not an intake form. Start with the lead's situation, follow the details they volunteer, and use the framework below to notice what you have not covered.

This guide covers the LPMAMA framework, buyer and seller question examples, and a three-layer approach to motivation. It builds on the broader [guide on how to talk to real estate leads](/blog/how-to-talk-to-real-estate-leads/), which covers openers, objection handling, and follow-up.
