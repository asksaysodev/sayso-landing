...
- **C-lead.** One MAT box checked, timeline 6 to 12 months, or decision-makers still forming. Long-game play. Drop them into a monthly nurture cadence with real value, not "just checking in" texts. Our guide on [how to keep control of a call](/blog/how-to-keep-control-of-a-call/) covers how to set expectations for the nurture cadence before you end the call.
