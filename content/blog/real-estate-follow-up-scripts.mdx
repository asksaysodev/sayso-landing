...
description: "Proven real estate follow up scripts for texts, calls, emails, and voicemails. Copy-paste scripts that turn cold leads into booked appointments. See how Sayso helps."
...
These leads have shown recent engagement. Your job is to move them to a conversation, not to educate or nurture. Keep messages short, ask for a specific time, and assume the appointment. When a lead would rather you just keep sending them listings, our guide to [handling "just send me listings"](/objections/just-send-listings/) shows how to redirect to a call.
...
3. **You disqualify them to a long-term [nurture track](/glossary/lead-nurturing/).** They are not transacting soon, but you now have a full picture of their situation and can move them to a monthly touch without guessing.
...
The full playbook for reviving long-dormant leads lives in the guide to [how to revive dead leads](/blog/how-to-revive-dead-leads/), and specific language for leads you have not spoken to in over a year is covered in [what to say to old leads](/blog/what-to-say-to-old-leads/).
...
Sayso also auto-generates call notes and syncs them to [Follow Up Boss](/integrations/partners/follow-up-boss/), Sierra, and KVCore, so your follow up cadence actually gets logged and triggered on time. That is the difference between planning to follow up and actually doing it. New to the tool? The [new agent overview](/for/new-agents/) walks through what the first week with Sayso looks like, and [how Sayso compares to Shilo](/compare/sayso-vs-shilo/) covers why real-time coaching beats post-call grading for agents who want help during the call.
