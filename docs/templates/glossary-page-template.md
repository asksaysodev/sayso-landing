...
- Format: `https://www.asksayso.com/glossary/[slug]/`
...
```json
{
  ...
  "url": "https://www.asksayso.com/glossary/circle-prospecting/",
  "inDefinedTermSet": {
    "@type": "DefinedTermSet",
    "name": "Sayso Real Estate Glossary",
    "url": "https://www.asksayso.com/glossary/"
  }
}
```
...
```json
{
  ...
  "itemListElement": [
    ...
    { "@type": "ListItem", "position": 2, "name": "Glossary", "item": "https://www.asksayso.com/glossary" },
