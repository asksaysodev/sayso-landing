...
- Format: `https://www.asksayso.com/for/[slug]/`
...
```json
{
  ...
  "url": "https://www.asksayso.com/for/[slug]",
...
```json
{
  ...
  "itemListElement": [
    ...
    { "@type": "ListItem", "position": 2, "name": "Solutions", "item": "https://www.asksayso.com/for" },
    { "@type": "ListItem", "position": 3, "name": "[Persona]", "item": "https://www.asksayso.com/for/[slug]" }
  ]
}
```
