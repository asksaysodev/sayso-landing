...
| **Meta description** | 150-160 characters max. Must contain the target keyword. Format: `[CRM Name] users: [what Sayso adds]. [Key benefit]. [CTA].` | `Follow Up Boss users: get real-time AI coaching and automatic call notes with Sayso. Every call logged to your CRM. Book a demo.` |
...
- Format: `https://www.asksayso.com/integrations/[slug]/`
...
```json
{
  ...
  "itemListElement": [
    ...
    { "@type": "ListItem", "position": 2, "name": "Integrations", "item": "https://www.asksayso.com/integrations" },
    { "@type": "ListItem", "position": 3, "name": "[CRM Name]", "item": "https://www.asksayso.com/integrations/[slug]" }
  ]
}
```
