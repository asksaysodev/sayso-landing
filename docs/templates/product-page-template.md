...
- Format: `https://www.asksayso.com/products/[slug]/`
...
```json
{
  ...
  "itemListElement": [
    ...
    { "@type": "ListItem", "position": 2, "name": "Features", "item": "https://www.asksayso.com/products" },
    { "@type": "ListItem", "position": 3, "name": "[H1]", "item": "https://www.asksayso.com/products/[slug]" }
  ]
}
```
