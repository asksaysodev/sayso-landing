...
--------------------------------------------------------------------------------
  PERSONA 1: BROKER / TEAM OWNER
  URL: /broker
  Targets: Broker Owner, Managing Broker, Broker of Record, Team Owner
--------------------------------------------------------------------------------
  ...
  Tagline:
    Sayso guides agents during live prospecting calls so they ask better
    questions, handle objections confidently, and convert more conversations
    into appointments.
...
--------------------------------------------------------------------------------
  ...
  URL: /sales-leader
  Targets: Director of Sales, Director of Operations, Sales Manager,
           Productivity Coach, Team Leader
--------------------------------------------------------------------------------
...
--------------------------------------------------------------------------------
  PERSONA 3: ISA / TEAM AGENT
  URL: /isa
  Targets: ISA, Inside Sales Agent, Prospecting Agent, Team Agent
--------------------------------------------------------------------------------

  HERO SECTION
  ─────────────
  Headline:
    Never run out of what to say on a prospect call.

  Tagline:
    Sayso gives you live prompts during prospecting calls so you always
  ...
  Metric Cards:
    1. Handle Any Objection
       Never freeze on 'just looking,' price objections, or FSBO pushback again

    2. Stay in Control
       Sayso keeps conversations moving toward a booked appointment
...
--------------------------------------------------------------------------------
  PERSONA 4: INDIVIDUAL AGENT
  URL: /agent
  Targets: Solo Agent, Independent Agent, New Agent
--------------------------------------------------------------------------------

  HERO SECTION
  ─────────────
  Headline:
    Prospecting gets easier when you know what to say next.

  Tagline:
    Sayso helps you ask better questions, handle objections, and turn
