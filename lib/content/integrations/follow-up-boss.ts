...
export const followUpBoss: IntegrationEntry = {
  ...
  howItWorks: [
    ...
    },
    {
      ...
      description:
        'Open Sayso and dial from your normal workflow. Sayso recognizes the contact from your FUB records.',
    },
    {
    ...
    },
    {
      ...
      description:
        'After the call, Sayso generates a summary and pushes it to the contact\'s FUB timeline. No copy-pasting, no manual logging.',
    },
  ],
  ...
  faq: [
    {
      ...
      answer:
        'Yes. The Follow Up Boss AI integration connects directly to your account and syncs call notes to your contact records automatically.',
    },
    {
    ...
    },
    {
      ...
      answer:
        'No. Sayso runs alongside your existing dialer and CRM. It adds coaching and notes without changing how you work.',
    },
    {
      question: 'Does it cost extra to use the Follow Up Boss integration?',
      answer:
        'No. The Follow Up Boss integration is included with your Sayso subscription. There is no additional fee to connect your FUB account.',
    },
    {
      question:
        'Does Sayso work with Follow Up Boss smart lists and calling from FUB?',
      answer:
        'Yes. Sayso recognizes contacts from your smart lists and works alongside calling from FUB. Notes sync back to the contact record regardless of how you initiate the call.',
    },
  ],
  relatedIntegrations: [],
  relatedLinks: [
