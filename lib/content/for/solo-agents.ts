...
export const soloAgents: UseCaseEntry = {
  ...
  theProblem: [
    ...
    'The result is a cycle that feels impossible to break: you need more conversations to grow, but the quality of each conversation suffers as the volume increases. Most agents hit a ceiling where their phone skills plateau and no amount of extra dials moves the needle.',
  ],
  whatTheyTryHeading: 'What Most Solo Agents Try (And Why It Falls Short)',
  whatTheyTry: [
