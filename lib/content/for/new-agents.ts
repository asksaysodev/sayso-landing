...
export const newAgents: UseCaseEntry = {
  slug: 'new-agents',
  persona: 'New Agents',
  keyword: 'how to get better at cold calling in real estate',
  seoTitle: 'Get Better at Cold Calling in Real Estate - New Agents',
  seoDescription:
    'New agents freeze when prospects push back. Learn how to get better at cold calling in real estate with real-time AI coaching on every call. Try Sayso.',
  h1: 'How to Get Better at Cold Calling in Real Estate',
  openingEmpathy: [
  ...
  theProblemHeading: 'Why Cold Calling Feels So Hard When You Are Starting Out',
  theProblem: [
  ...
  whatTheyTryHeading: 'What Most New Agents Try (And Why It Falls Short)',
  whatTheyTry: [
  ...
  betterApproachHeading: 'A Better Way to Get Better at Cold Calling',
  betterApproach: [
  ...
  faq: [
    {
      question: 'How does Sayso help new agents get better at cold calling in real estate?',
      answer:
        'Sayso listens to your live calls and shows coaching prompts on your screen in real time. When a prospect raises an objection, you see a proven response immediately. Instead of spending months memorizing scripts, you learn on the job with guidance on every call.',
    },
    {
      question: 'Do I need to memorize scripts before I start using Sayso?',
      answer:
        'No. Sayso shows your scripts and talk tracks on screen during calls, so you can follow along naturally. Over time, you will internalize the material, but you do not need to memorize anything before you start dialing.',
    },
    {
      question: 'Can Sayso help me handle objections I have never heard before?',
      answer:
        'Yes. Sayso generates responses based on what the prospect just said, not from a static list. Even if an objection catches you off guard, Sayso provides a relevant response in real time so you can keep the conversation moving.',
    },
    {
      question: 'How quickly will I see improvement on my calls?',
      answer:
        'Most new agents notice a difference on their first session. You stop freezing on objections and start having longer, more productive conversations. The improvement compounds as you build confidence and pattern recognition with each call.',
    },
    {
  ...
  relatedBlogPosts: [
    ...
    { title: 'How to Practice Real Estate Scripts (So You Sound Like a Pro, Not a Robot)', href: '/blog/how-to-practice-real-estate-scripts' },
  ],
  relatedObjections: [
    ...
    { title: '"I\'m Just Looking" \u2014 How to Respond', href: '/objections/just-looking' },
  ],
};
