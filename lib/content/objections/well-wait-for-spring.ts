...
export const wellWaitForSpring: ObjectionEntry = {
  slug: 'well-wait-for-spring',
  keyword: 'how to handle timing objection real estate',
  seoTitle: 'How to Handle the Timing Objection in Real Estate',
  seoDescription:
    'Learn how to handle the timing objection in real estate with 3 proven scripts. Keep the conversation alive when a prospect says they want to wait for spring.',
  h1: 'How to Handle the Timing Objection in Real Estate',
  objectionQuote: "We'll wait for spring.",
  openingParagraph:
  ...
  whyTheyTitle: 'Why Prospects Say "We\'ll Wait for Spring"',
  whyTheySayThis:
  ...
  responses: {
    safe: {
      ...
      whyItWorks:
        'This validates their plan and reframes the conversation. By separating "start exploring" from "move," you give them permission to engage now without feeling committed to act immediately.',
    },
    stronger: {
      ...
      whyItWorks:
        'This forces the prospect to define what spring actually means. Once they articulate their real reason, you can address it directly or show them why starting earlier helps.',
    },
    advanced: {
      ...
      whyItWorks:
        'This reframes waiting as a risk and preparation as the smart move. You position yourself as the agent who gets them ahead by starting early, not the one pushing them to act now.',
    },
  },
  whatToSayNext:
  ...
  faq: [
    {
      question: 'What does "we\'ll wait for spring" really mean in real estate?',
      answer:
        'It usually means the prospect is defaulting to conventional wisdom rather than making a calculated decision. Most people have not thought through what waiting costs, and with the right question, you can uncover the real reason behind the delay.',
    },
    {
      question: 'How do you create urgency without being pushy when a prospect wants to wait?',
      answer:
        'Focus on preparation instead of pressure. Offer to help them get ready so they are in a strong position when their preferred timeline arrives. This shifts you from salesperson to advisor.',
    },
    {
      question: 'Should I keep following up with a prospect who says they will wait for spring?',
      answer:
        'Yes, always. A prospect who gives you a timeline is a warm lead. Schedule periodic follow-ups, send market updates for their area, and reference your earlier conversation when you reconnect.',
    },
    {
      question: 'How can AI help agents handle timing objections on calls?',
      answer:
        'Tools like Sayso surface real-time market data and coaching prompts during live calls, so you can respond to timing objections with specific local numbers instead of generic talking points. It helps you sound informed and confident in the moment.',
    },
  ],
  relatedBlogPost: {
