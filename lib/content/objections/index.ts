...
const entries: ObjectionEntry[] = [alreadyHaveAnAgent, alreadyListed, badExperienceWithAgents, callMeLater, justLooking, marketIsBad, needToThinkAboutIt, notInterested, notReadyYet, priceTooHigh, wantToSellOurselves];
