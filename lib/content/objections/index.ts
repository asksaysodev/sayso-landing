...
const entries: ObjectionEntry[] = [alreadyHaveAnAgent, alreadyListed, callMeLater, justLooking, marketIsBad, needToThinkAboutIt, notInterested, notReadyYet, priceTooHigh, wantToSellOurselves];
