...
export const notReadyYet: ObjectionEntry = {
  ...
  responses: {
    ...
    advanced: {
      ...
      whyItWorks:
        'This reframes "not ready" as an advantage. You position the lack of urgency as a positive, then pivot to a discovery question that gets the prospect talking about their motivation. Once they start sharing why they were thinking about moving, they are engaged in a real conversation.',
    },
  },
  whatToSayNext:
