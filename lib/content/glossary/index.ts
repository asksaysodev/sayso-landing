...
const entries: GlossaryEntry[] = [circleProspecting, coldCallingRealEstate, doorKnocking, dripCampaign, fsbo, isaRealEstate, leadNurturing, listingAppointment, sphereOfInfluence];
