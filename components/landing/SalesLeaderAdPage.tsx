    ...
    <div className="bg-white min-h-screen">
      ...
      <div className="max-w-xl mx-auto px-6 pb-10">
        <div className="flex items-center gap-3 text-sm text-[#1D4871]/60">
          ...
          <span className="whitespace-nowrap text-center">
            Built for teams, tracking calls, and conversation conversion
          </span>
          <div className="h-px flex-1 bg-[#1D4871]/15" />
        </div>
      </div>
      ...
      <section className="max-w-xl mx-auto px-6 py-8 text-center">
        <h2 className="font-comic text-2xl sm:text-3xl text-[#1D4871] mb-3 leading-snug">
          Your agents are making the calls. But they aren&apos;t converting to appointments.
        </h2>
        <ul className="space-y-3">
          {[
            "Agents generate a ton of leads but struggle to convert them",
            "Agents don't call because they \"don't know what to say\"",
            "Your CRM and lead notes are a mess without any consistent notes",
          ].map((item) => (
      ...
      <section className="max-w-xl mx-auto px-6 py-4 text-center">
        <p className="font-comic text-xl sm:text-2xl text-[#1D4871]">
          Conversations is the key KPI, but agents don&apos;t know how to have them, and your results suffer
        </p>
      </section>
            ...
            {[
              {
                ...
                desc: 'Conquer their phone phobia and get results sooner',
              },
              {
                icon: <TrendingUp size={18} />,
                title: 'See better performance',
                desc: 'Real-time guidance creates more results than reactive coaching days later',
              },
              {
                icon: <Users size={18} />,
