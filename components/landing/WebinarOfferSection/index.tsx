 ...
 *   2. OfferBreakdown: itemized value of everything included, summed
 *   3. SavingsCallout: full value vs the $3,000 today price, savings emphasized
 *   4. ClaimCta: primary button that starts the booking flow
