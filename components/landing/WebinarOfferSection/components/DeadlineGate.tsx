 ...
 * deadline (from ?d= / mockup fallback), a live session sees the offer and an
 * expired one sees the expired state instead. Before mount it renders the offer,
 * so live visitors (the common case) never flash.
 */
